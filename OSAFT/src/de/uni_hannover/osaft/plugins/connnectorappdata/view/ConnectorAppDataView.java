...
public class ConnectorAppDataView extends MouseAdapter implements ViewPlugin, ActionListener, ListSelectionListener, KeyListener,
	...
	private JButton openCSVButton, pushAppButton, pullCSVButton, uninstallAppButton;
	...
	public void initGUI() {
		...
		pushAppButton = new JButton("Install app on phone");
		...
		uninstallAppButton = new JButton("Uninstall App");
		uninstallAppButton.addActionListener(this);

		currentFolderLabel = new JLabel();
		actualCurrentFolderLabel = new JLabel();

		preferencesPanel = new JPanel();
		preferencesPanel.setName("Preferences");
		preferencesPanel.add(currentFolderLabel);
		preferencesPanel.add(actualCurrentFolderLabel);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == openCSVButton) {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				if (controller.iterateChosenFolder(folder)) {
					...
					actualCurrentFolderLabel.setText(folder.getName());
					currentFolderLabel.setText("Files from folder: ");
				} else {
					actualCurrentFolderLabel.setText("");
		...
		if (e.getSource() == uninstallAppButton) {
			adb.executeAndReturn("uninstall de.uni_hannover.android.artifactextract", this, true);
		}
